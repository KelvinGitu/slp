...
class _ACContactorTripleState extends ConsumerState<ACContactorTriple> {
  ...
  void updateSinglePoleContactorRequiredStatus(bool required) {
    ref.watch(solarControllerProvider).updateApplicationComponentRequiredStatus(
          '100A AC Single Pole Contactor',
          required,
          widget.applicationId,
        );
  }

  void updateSinglePoleContactorSelectedStatus(bool required) {
    ref.watch(solarControllerProvider).updateApplicationComponentSelectedStatus(
          '100A AC Single Pole Contactor',
          required,
          widget.applicationId,
                              ...
                              children: [
                                ...
                                YesNoButton(
                                  onPressed: () {
                                    ...
                                    updateSinglePoleContactorRequiredStatus(
                                        true);
                                  },
                                  yesNo: 'No',
                                  ...
                                  children: [
                                    ...
                                    ConfirmSelectionButton(
                                      onPressed: () {
                                        ...
                                        updateSinglePoleContactorRequiredStatus(
                                            false);
                                        updateSinglePoleContactorSelectedStatus(
                                            false);
