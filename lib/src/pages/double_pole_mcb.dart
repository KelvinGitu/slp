...
class DoublePoleMCB extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _DoublePoleMCBState();
}

class _DoublePoleMCBState extends ConsumerState<DoublePoleMCB> {
