...
class HeatShrinkTube extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _HeatShrinkTubeState();
}

class _HeatShrinkTubeState extends ConsumerState<HeatShrinkTube> {
  bool validate = false;
