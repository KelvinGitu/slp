...
class SixMMCoreCable extends ConsumerStatefulWidget {
  final String component;
  final String applicationId;
  const SixMMCoreCable({
    super.key,
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _SixMMCoreCableState();
}

class _SixMMCoreCableState extends ConsumerState<SixMMCoreCable> {
