...
final getFutureSelectedBreakersStreamProvider =
    FutureProvider.family<List<DCBreakerModel>, List<String>>((ref, arguments) {
  return ref
      .watch(dcBreakerControllerProvider)
      .getFutureSelectedBreakers(arguments[0], arguments[1]);
});
